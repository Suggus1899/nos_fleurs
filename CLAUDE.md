...
- `src/components/admin/product-form.tsx` — the create/edit form; note `encType="multipart/form-data"` is required on the `<form>` for the file input's no-JS fallback path to work.
